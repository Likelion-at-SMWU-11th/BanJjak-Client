...
function Home() {
    ...
    return (
        ...
        <p id="clock_p2"><span style={{ fontWeight: 'bold'}}>{formattedDate}</span>{formattedTime}</p>
        </div>

        <div id="statistics">
            <div id="percentage">
                <p>입양률 <span style={{ color : '#3E3E3E' }}>22.3%</span></p>
                <p>안락사율 <span style={{ color : '#FF0000' }}>14.4%</span></p>
            </div>
            <div id="rescue">
                <p>오늘 구조된 동물</p>
                <p style={{ fontWeight : 'bold', color:"#00AC78", fontSize:'30px'}}>8<span style={{ color : '#3E3E3E', fontSize : '18px'}}>마리</span></p>
            </div>
        </div>
